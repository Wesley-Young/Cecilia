 ...
 */
fun getAppDataDirectory(): java.nio.file.Path {
...
private fun getWindowsAppDataDirectory(userHome: String): java.nio.file.Path {
    ...
    return appDataRoot.resolve("Cecilia")
}

private fun getLinuxAppDataDirectory(userHome: String): java.nio.file.Path {
    ...
    return dataRoot.resolve("cecilia")
}
