...
export type IncomingSegmentDisplayProps = {
  segments: IncomingSegment[];
  noFg?: boolean;
};

export function IncomingSegmentDisplay({ segments, noFg }: IncomingSegmentDisplayProps) {
...
export type OutgoingSegmentDisplayProps = {
  segments: OutgoingSegment[];
  noFg?: boolean;
};

export function OutgoingSegmentDisplay({ segments, noFg }: OutgoingSegmentDisplayProps) {
  return segments.map((seg) => {
    switch (seg.type) {
      case 'text':
        return seg.data.text;
